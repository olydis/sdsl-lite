...
typedef Types<select_support_mcl<>,select_support_rrr<>,select_support_sd<1>,select_support_sd<0>,select_0_support_sd<>,select_support_il<1, 512>,select_support_mcl<0>,select_support_rrr<0>,select_support_il<0, 512>,select_support_mcl<01,2>,select_support_mcl<10,2>,select_support_mcl<00,2>,select_support_mcl<11,2>> Implementations;
